...
public class BodyRequest extends Request {
    ...
    public static Builder newBuilder(String url, RequestMethod method) {
        return newBuilder(Url.newBuilder(url).build(), method);
    }

    public static Builder newBuilder(Url url, RequestMethod method) {
     ...
     */
    @Deprecated
    public static Builder newBuilder(Url.Builder url, RequestMethod method) {
