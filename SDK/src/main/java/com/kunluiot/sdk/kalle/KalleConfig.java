 ...
 */
package com.kunluiot.sdk.kalle;

import com.kunluiot.sdk.kalle.connect.ConnectFactory;
import com.kunluiot.sdk.kalle.connect.Interceptor;
import com.kunluiot.sdk.kalle.connect.Network;
import com.kunluiot.sdk.kalle.cookie.CookieStore;
import com.kunluiot.sdk.kalle.simple.Converter;
import com.kunluiot.sdk.kalle.simple.cache.CacheStore;
import com.kunluiot.sdk.kalle.ssl.SSLUtils;
import com.kunluiot.sdk.kalle.urlconnect.URLConnectionFactory;
import com.kunluiot.sdk.kalle.util.MainExecutor;
import com.kunluiot.sdk.kalle.util.WorkExecutor;
...
import static com.kunluiot.sdk.kalle.Headers.KEY_ACCEPT;
import static com.kunluiot.sdk.kalle.Headers.KEY_ACCEPT_ENCODING;
import static com.kunluiot.sdk.kalle.Headers.KEY_ACCEPT_LANGUAGE;
import static com.kunluiot.sdk.kalle.Headers.KEY_CONNECTION;
import static com.kunluiot.sdk.kalle.Headers.KEY_CONTENT_TYPE;
import static com.kunluiot.sdk.kalle.Headers.KEY_USER_AGENT;
import static com.kunluiot.sdk.kalle.Headers.VALUE_ACCEPT_ALL;
import static com.kunluiot.sdk.kalle.Headers.VALUE_ACCEPT_ENCODING;
import static com.kunluiot.sdk.kalle.Headers.VALUE_ACCEPT_LANGUAGE;
import static com.kunluiot.sdk.kalle.Headers.VALUE_APPLICATION_URLENCODED;
import static com.kunluiot.sdk.kalle.Headers.VALUE_KEEP_ALIVE;
import static com.kunluiot.sdk.kalle.Headers.VALUE_USER_AGENT;
