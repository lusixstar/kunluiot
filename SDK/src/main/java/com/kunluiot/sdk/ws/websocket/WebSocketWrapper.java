    ...
    void send(Request request) {
        ...
        if (connectStatus == 2) {
            try {
                ...
                LogUtil.i(TAG, "send success:"+mSetting.getConnectUrl()+"--" + request.toString());
            ...
            LogUtil.e(TAG, "WebSocket not connect,send failed:"+mSetting.getConnectUrl()+"--" + request.toString());
            if (mSocketListener != null) {
                //not connect
                mSocketListener.onSendDataError(request,
                        ErrorResponse.ERROR_NO_CONNECT,
