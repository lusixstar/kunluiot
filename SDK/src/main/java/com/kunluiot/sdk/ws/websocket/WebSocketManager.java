package com.kunluiot.sdk.ws.websocket;


import android.text.TextUtils;


import com.kunluiot.sdk.ws.websocket.dispatcher.MainThreadResponseDelivery;
import com.kunluiot.sdk.ws.websocket.dispatcher.ResponseDelivery;
import com.kunluiot.sdk.ws.websocket.dispatcher.ResponseProcessEngine;
import com.kunluiot.sdk.ws.websocket.request.Request;
import com.kunluiot.sdk.ws.websocket.request.RequestFactory;
import com.kunluiot.sdk.ws.websocket.response.ErrorResponse;
import com.kunluiot.sdk.ws.websocket.response.Response;
import com.kunluiot.sdk.ws.websocket.response.ResponseFactory;
...
public class WebSocketManager {
    ...
    public WebSocketManager reconnect() {
        ...
        LogUtil.d(TAG, "mReconnectManager.reconnecting() === "+mReconnectManager.reconnecting());
    ...
    public WebSocketManager reconnect(WebSocketSetting setting) {
        disconnect = false;
        if (destroyed) {
            LogUtil.e(TAG, "This WebSocketManager is destroyed!-reconnect");
            return this;
        }
        this.mSetting = setting;
        if (mWebSocket != null) {
    ...
    public WebSocketManager disConnect() {
        disconnect = true;
        if (destroyed) {
            LogUtil.e(TAG, "This WebSocketManager is destroyed!-disConnect");
            return this;
        }
        if (mWebSocket.getConnectState() != 0) {
    ...
    void reconnectOnce() {
        if (destroyed) {
            LogUtil.e(TAG, "This WebSocketManager is destroyed!-reconnectOnce");
            return;
        }
        if (mWebSocket.getConnectState() == 0) {
    ...
    private void sendRequest(Request request) {
        if (destroyed) {
            LogUtil.e(TAG, "This WebSocketManager is destroyed!-sendRequest");
            return;
        }
