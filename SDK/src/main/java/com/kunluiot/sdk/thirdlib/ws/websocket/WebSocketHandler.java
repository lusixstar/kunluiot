...
import com.kunluiot.sdk.thirdlib.ws.websocket.util.LogImpl;
import com.kunluiot.sdk.thirdlib.ws.websocket.util.LogUtil;
import com.kunluiot.sdk.thirdlib.ws.websocket.util.Logable;
import com.kunluiot.sdk.thirdlib.ws.websocket.util.PermissionUtil;
...
public class WebSocketHandler {
    ...
    public static void reset(){
        ...
        defaultWebSocket = null;
        mWebSocketMap.remove("remote_webSocket");
      //  mWebSocketMap.clear();
    ...
    public static WebSocketManager initGeneralWebSocket(String key, WebSocketSetting setting) {
        ...
        synchronized (WS_MAP_BLOCK) {
            if (mWebSocketMap.containsKey(key)) {
                LogUtil.e(TAG, "WebSocketManager exists!do not start again  1111!"+key);
