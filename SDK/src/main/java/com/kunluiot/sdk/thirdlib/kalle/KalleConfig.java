...
import com.kunluiot.sdk.thirdlib.kalle.cookie.CookieStore;
import com.kunluiot.sdk.thirdlib.kalle.simple.Converter;
import com.kunluiot.sdk.thirdlib.kalle.simple.cache.CacheStore;
import com.kunluiot.sdk.thirdlib.kalle.ssl.SSLUtils;
import com.kunluiot.sdk.thirdlib.kalle.urlconnect.URLConnectionFactory;
import com.kunluiot.sdk.thirdlib.kalle.util.MainExecutor;
import com.kunluiot.sdk.thirdlib.kalle.util.WorkExecutor;
...
public final class KalleConfig {
    ...
    public final static class Builder {
        ...
        private Builder() {
            ...
            mHeaders.set(Headers.KEY_ACCEPT, Headers.VALUE_ACCEPT_ALL);
            mHeaders.set(Headers.KEY_ACCEPT_ENCODING, Headers.VALUE_ACCEPT_ENCODING);
            mHeaders.set(Headers.KEY_CONTENT_TYPE, Headers.VALUE_APPLICATION_URLENCODED);
            mHeaders.set(Headers.KEY_CONNECTION, Headers.VALUE_KEEP_ALIVE);
            mHeaders.set(Headers.KEY_USER_AGENT, Headers.VALUE_USER_AGENT);
            mHeaders.set(Headers.KEY_ACCEPT_LANGUAGE, Headers.VALUE_ACCEPT_LANGUAGE);
        }
