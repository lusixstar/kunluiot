...
import com.kunluiot.sdk.thirdlib.kalle.exception.DownloadError;
import com.kunluiot.sdk.thirdlib.kalle.util.IOUtils;
import com.kunluiot.sdk.thirdlib.kalle.util.UrlUtils;
        ...
        try {
            ...
            if (TextUtils.isEmpty(mFileName)) {
                ...
                if (mPolicy.isRange() && tempFile.exists()) {
                    ...
                    toHeaders.set(Headers.KEY_RANGE, "bytes=" + tempFile.length() + "-");
                    response = requestNetwork(mDownload);
                    code = response.code();
                    comeHeaders = response.headers();
                } else {
