...
import com.kunluiot.sdk.thirdlib.kalle.BodyRequest;
import com.kunluiot.sdk.thirdlib.kalle.Canceller;
import com.kunluiot.sdk.thirdlib.kalle.RequestMethod;
import com.kunluiot.sdk.thirdlib.kalle.Url;
...
public class SimpleBodyRequest extends BodyRequest implements SimpleRequest {
    ...
    public static Api newApi(Url url, RequestMethod method) {
