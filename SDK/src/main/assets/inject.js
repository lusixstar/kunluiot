...
window.Matrix = (function () {
    ...
    function syncFunc(name, parameters) {
        return JSON.parse(window.__HEKR__BRIDGE.__syncCall(JSON.stringify({name, parameters}))).result;
    };
    setTimeout(function() {
    ...
    return {
        ...
        setActionToEquipment: function (device) {


           return noReturnFunc('connect', device);
        },
        getDomain: function () {
        ...
        setMusicRhythmColor: function (data) {
                    var dict = { data: data};

                    return noReturnFunc('setMusicRhythmColor', dict);
        },
        screenShot: function () {
