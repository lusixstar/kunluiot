...
class SceneSelectDevicesListAdapter(list: MutableList<FolderBean>, private val delete: (DeviceNewBean) -> Unit) : BaseQuickAdapter<FolderBean, BaseViewHolder>(R.layout.item_room_list, list) {
